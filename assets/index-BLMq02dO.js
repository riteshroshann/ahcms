          ...
          ${l.map(o=>`
            <div class="contact-row" style="align-items: flex-start;">
              ...
              <div class="contact-info" style="flex: 1;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 12px; font-size: 11px; margin-top: 8px; padding-top: 8px; border-top: 1px solid var(--border-color); color: var(--text-secondary);">
                  <span><span style="font-weight:600; color:var(--text-tertiary);">Last:</span> ${o.previous?o.previous.name:"Unknown"}</span>
                  <span style="color:var(--accent-green);"><span style="font-weight:600;">Current:</span> Active</span>
                  <span><span style="font-weight:600; color:var(--text-tertiary);">Next:</span> ${o.next?o.next.name:"Unknown"}</span>
                </div>
              </div>
            </div>
          `).join("")}
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <select class="form-select" id="res-cat" required>
                ...
                ${U.map(i=>`<option value="${i}">${_[i]} ${i}</option>`).join("")}
              </select>
      ...
      <div class="table-container">
        <div class="table-toolbar">
          ...
          <div style="display:flex; gap:var(--space-2); flex-wrap:wrap;">
            ...
            ${U.map(i=>`<button class="filter-chip" data-cat="${i}">${_[i]} ${i}</button>`).join("")}
          </div>
        </div>
