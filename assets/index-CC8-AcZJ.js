(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))c(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const m of r.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&c(m)}).observe(document,{childList:!0,subtree:!0});function l(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function c(i){if(i.ep)return;i.ep=!0;const r=l(i);fetch(i.href,r)}})();const T="ahcms_token",_="ahcms_user";(function(){const o=localStorage.getItem("cw_hostel_token"),l=localStorage.getItem("cw_hostel_user");o&&(localStorage.setItem(T,o),localStorage.removeItem("cw_hostel_token")),l&&(localStorage.setItem(_,l),localStorage.removeItem("cw_hostel_user"))})();function F(a,o){localStorage.setItem(T,a),localStorage.setItem(_,JSON.stringify(o))}function Y(){return localStorage.getItem(T)}function H(){try{return JSON.parse(localStorage.getItem(_))}catch{return null}}function D(){var a;return((a=H())==null?void 0:a.role)||null}function ee(){const a=Y();if(!a)return!1;try{return JSON.parse(atob(a.split(".")[1])).exp*1e3>Date.now()}catch{return!1}}function K(){localStorage.removeItem(T),localStorage.removeItem(_)}const $={home:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',complaints:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="15" r="0.5" fill="currentColor"/></svg>',booking:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>',forum:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 8h2a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2v4l-4-4H9a2 2 0 0 1-2-2v-1"/><path d="M15 3H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2v4l4-4h4a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z"/></svg>',rooms:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',resources:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',logout:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>',theme:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>',menu:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>'},te=[{id:"home",label:"Home",icon:$.home},{id:"complaints",label:"Complaint",icon:$.complaints},{id:"booking",label:"Room Booking",icon:$.booking},{id:"forum",label:"Community Forum",icon:$.forum},{id:"resources",label:"Resources",icon:$.resources}],ae=[{id:"home",label:"Home",icon:$.home},{id:"complaints",label:"Complaints",icon:$.complaints},{id:"rooms",label:"Room Details",icon:$.rooms},{id:"forum",label:"Community Forum",icon:$.forum},{id:"resources",label:"Resources",icon:$.resources}];function oe(a,o,l){var d,s;const c=D(),i=H(),r=c==="admin"?ae:te,m=c==="admin"?"Admin Panel":"Student Portal";a.innerHTML=`
  ...
  `,a.querySelectorAll(".nav-item[data-page]").forEach(e=>{e.addEventListener("click",()=>l(e.dataset.page)),e.addEventListener("keydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),e.click())})}),(d=document.getElementById("nav-logout"))==null||d.addEventListener("click",()=>{K(),window.location.reload()}),(s=document.getElementById("nav-theme"))==null||s.addEventListener("click",()=>{const t=(document.documentElement.getAttribute("data-theme")||"light")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",t),localStorage.setItem("ahcms_theme",t)})}function se(){const a=document.createElement("button");a.className="sidebar-toggle",a.id="sidebar-toggle",a.innerHTML=$.menu,a.setAttribute("aria-label","Toggle navigation");const o=document.createElement("div");o.className="sidebar-overlay",o.id="sidebar-overlay",document.body.appendChild(a),document.body.appendChild(o);const l=document.getElementById("sidebar");function c(){l.classList.add("open"),o.classList.add("show"),a.innerHTML=$.close}function i(){l.classList.remove("open"),o.classList.remove("show"),a.innerHTML=$.menu}return a.addEventListener("click",()=>l.classList.contains("open")?i():c()),o.addEventListener("click",i),{close:i}}const re="/api";async function S(a,o,l){const c=Y(),i={"Content-Type":"application/json"};c&&(i.Authorization=`Bearer ${c}`);const r=new AbortController,m=setTimeout(()=>r.abort(),1e4);try{const d=await fetch(`${re}${o}`,{method:a,headers:i,body:l!==void 0?JSON.stringify(l):void 0,signal:r.signal});if(d.status===401){K(),window.location.reload();return}const s=await d.json().catch(()=>({}));if(!d.ok)throw new Error(s.error||`Request failed (${d.status})`);return s}catch(d){throw d.name==="AbortError"?new Error("Request timed out — is the server running?"):d}finally{clearTimeout(m)}}const f={get:a=>S("GET",a),post:(a,o)=>S("POST",a,o),patch:(a,o)=>S("PATCH",a,o),put:(a,o)=>S("PUT",a,o),delete:a=>S("DELETE",a)};let I=null;function ie(){I||(I=document.createElement("div"),I.className="toast-container",document.body.appendChild(I))}function h(a,o="info",l=3500){ie();const c=document.createElement("div");c.className=`toast toast-${o}`,c.textContent=a,I.appendChild(c),requestAnimationFrame(()=>{requestAnimationFrame(()=>{c.classList.add("show")})}),setTimeout(()=>{c.classList.remove("show"),setTimeout(()=>c.remove(),300)},l)}function ne(a){var c;document.body.innerHTML=`
  ...
  `,(c=document.getElementById("login-theme"))==null||c.addEventListener("click",()=>{const r=(document.documentElement.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",r),localStorage.setItem("ahcms_theme",r)});let o="student";document.querySelectorAll(".login-tab").forEach(i=>{i.addEventListener("click",()=>{o=i.dataset.tab,document.querySelectorAll(".login-tab").forEach(r=>r.classList.remove("active")),i.classList.add("active"),document.getElementById("form-student").classList.toggle("hidden",o!=="student"),document.getElementById("form-admin").classList.toggle("hidden",o!=="admin"),document.getElementById("form-register").classList.add("hidden")})}),document.getElementById("btn-show-register").addEventListener("click",()=>{document.getElementById("form-admin").classList.add("hidden"),document.getElementById("form-register").classList.remove("hidden")}),document.getElementById("btn-back-login").addEventListener("click",()=>{document.getElementById("form-register").classList.add("hidden"),document.getElementById("form-admin").classList.remove("hidden")});function l(i,r){const m=document.getElementById(i);m.disabled=r,m.textContent=r?"Signing in…":"Sign In"}document.getElementById("form-student").addEventListener("submit",async i=>{i.preventDefault();const r=document.getElementById("s-roll").value.trim(),m=document.getElementById("s-pass").value,d=document.getElementById("err-student");if(d.textContent="",!r||!m){d.textContent="All fields required.";return}l("btn-student-login",!0);try{const{token:s,user:e}=await f.post("/auth/student/login",{roll_no:r,password:m});F(s,e),a()}catch(s){d.textContent=s.message}finally{l("btn-student-login",!1)}}),document.getElementById("form-admin").addEventListener("submit",async i=>{i.preventDefault();const r=document.getElementById("a-email").value.trim(),m=document.getElementById("a-pass").value,d=document.getElementById("err-admin");if(d.textContent="",!r||!m){d.textContent="All fields required.";return}l("btn-admin-login",!0);try{const{token:s,user:e}=await f.post("/auth/admin/login",{email:r,password:m});F(s,e),a()}catch(s){d.textContent=s.message}finally{l("btn-admin-login",!1)}}),document.getElementById("form-register").addEventListener("submit",async i=>{i.preventDefault();const r=document.getElementById("r-name").value.trim(),m=document.getElementById("r-email").value.trim(),d=document.getElementById("r-pass").value,s=document.getElementById("err-register");if(s.textContent="",!r||!m||!d){s.textContent="All fields required.";return}if(d.length<8){s.textContent="Password must be at least 8 characters.";return}const e=document.getElementById("btn-register");e.disabled=!0,e.textContent="Creating…";try{await f.post("/auth/admin/register",{name:r,email:m,password:d}),h("Account created! Please sign in.","success"),document.getElementById("btn-back-login").click(),document.getElementById("a-email").value=m}catch(t){s.textContent=t.message}finally{e.disabled=!1,e.textContent="Create Account"}})}async function le(a){a.innerHTML='<div class="page-loading">Loading…</div>';try{const{student:o,allocation:l,complaints:c,wardens:i,wardenOfficePhone:r}=await f.get("/dashboard/student");de(a,o,l,c,i,r)}catch(o){a.innerHTML=`<div class="page-error">Failed to load dashboard: ${o.message}</div>`}}function de(a,o,l,c,i,r){var s;const m=i.filter(e=>e.role==="Warden"),d=i.filter(e=>e.role==="Guard");a.innerHTML=`
  ...
  `,a.querySelectorAll('a.link-accent[href^="#"]').forEach(e=>{e.addEventListener("click",t=>{t.preventDefault(),window.location.hash=e.getAttribute("href").slice(1)})}),requestAnimationFrame(()=>{var e;return(e=document.getElementById("student-home"))==null?void 0:e.classList.replace("page-enter","page-active")})}const j=["Plumbing","Electricity","WiFi","Cleanliness","Carpentry","Other"],P={Plumbing:"🔧",Electricity:"⚡",WiFi:"📶",Cleanliness:"🧹",Carpentry:"🔨",Other:"📋"},ce=["open","in-progress","resolved"];async function pe(a){a.innerHTML='<div class="page-loading">Loading…</div>';let o=[];try{o=await f.get("/complaints")}catch(l){a.innerHTML=`<div class="page-error">Failed to load: ${l.message}</div>`;return}me(a,o)}function me(a,o){let l=o,c="all",i="";a.innerHTML=`
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <select class="form-select" id="cmp-category" required>
                ...
                ${j.map(e=>`<option value="${e}">${P[e]} ${e}</option>`).join("")}
              </select>
  ...
  `;function r(){let e=l;i&&(e=e.filter(n=>n.category===i)),c!=="all"&&(e=e.filter(n=>n.status===c));const t=document.getElementById("complaints-list");if(e.length===0){t.innerHTML='<p style="padding: var(--space-8); text-align:center; color: var(--text-tertiary);">No complaints found.</p>';return}t.innerHTML=`
    ...
    `}document.getElementById("cat-filter-select").addEventListener("change",e=>{i=e.target.value,r()}),a.querySelectorAll("[data-status]").forEach(e=>{e.addEventListener("click",()=>{a.querySelectorAll("[data-status]").forEach(t=>t.classList.remove("active")),e.classList.add("active"),c=e.dataset.status,r()})});const m=document.getElementById("cmp-category"),d=document.getElementById("cmp-other-group");m.addEventListener("change",e=>{e.target.value==="Other"?d.style.display="":(d.style.display="none",document.getElementById("cmp-other-type").value="",document.getElementById("err-cmp-other").classList.remove("visible"))});const s=document.getElementById("complaint-form");s.addEventListener("submit",async e=>{e.preventDefault();let t=!0;a.querySelectorAll(".form-error").forEach(v=>v.classList.remove("visible"));const n=document.getElementById("cmp-category").value,u=document.getElementById("cmp-other-type").value.trim(),g=document.getElementById("cmp-desc").value.trim(),y=document.getElementById("cmp-photo").files[0];if(n||(document.getElementById("err-cmp-cat").classList.add("visible"),t=!1),n==="Other"&&!u&&(document.getElementById("err-cmp-other").classList.add("visible"),t=!1),g||(document.getElementById("err-cmp-desc").classList.add("visible"),t=!1),!t){h("Fill in all required fields.","error");return}const p=document.getElementById("cmp-submit");p.disabled=!0,p.textContent="Submitting…";try{let v=null;y&&(v=await new Promise((b,w)=>{const C=new FileReader;C.onload=()=>b(C.result),C.onerror=w,C.readAsDataURL(y)}));const x=n==="Other"&&u?`[Other: ${u}] ${g}`:g,E=await f.post("/complaints",{category:n,description:x,photo_base64:v});l=[E,...l],h(`Complaint #${E.complaint_id} submitted.`,"success"),s.reset(),r()}catch(v){h(v.message,"error")}finally{p.disabled=!1,p.textContent="Submit Complaint"}}),s.addEventListener("reset",()=>{a.querySelectorAll(".form-error").forEach(e=>e.classList.remove("visible")),document.getElementById("cmp-other-group").style.display="none"}),r(),requestAnimationFrame(()=>{var e;return(e=document.getElementById("complaints-page"))==null?void 0:e.classList.replace("page-enter","page-active")})}async function Q(a){a.innerHTML='<div class="page-loading">Loading rooms…</div>';try{const[o,{allocation:l},c]=await Promise.all([f.get("/rooms"),f.get("/rooms/my-allocation"),f.get("/rooms/booking-requests")]);ve(a,o,l,c)}catch(o){a.innerHTML=`<div class="page-error">Failed to load: ${o.message}</div>`}}function ve(a,o,l,c){var g,y,p;const i=H(),r=o.filter(v=>v.hostel===((i==null?void 0:i.hostel)||"")),m=[...new Set(r.map(v=>v.floor))].sort((v,x)=>v-x);let s=m[0]||1,e=null;const t=c.find(v=>v.status==="pending");a.innerHTML=`
  ...
  `;function n(v){const x=r.filter(b=>b.floor===v);document.getElementById("floor-plan-title").textContent=`Floor ${v} — ${(i==null?void 0:i.hostel)||""}`;const E=document.getElementById("floor-plan");if(x.length===0){E.innerHTML='<p style="color:var(--text-tertiary); padding: var(--space-4);">No rooms on this floor.</p>';return}E.innerHTML=x.map(b=>{const w=b.capacity>0?b.current_occupancy/b.capacity:0,C=w===0?"vacant":w<1?"partial":"full",Z=(e==null?void 0:e.room_id)===b.room_id;return`
        <button class="room-cell ${C}${Z?" selected":""}"
                data-room="${b.room_id}"
                ${C==="full"?"disabled":""}
  ...
  `;function i(){const m=document.getElementById("forum-feed"),d=document.getElementById("forum-empty");if(c.length===0){m.innerHTML="",d.style.display="block";return}d.style.display="none",m.innerHTML=c.map(s=>`
      <div class="forum-post card" style="background:var(--bg-primary); padding:var(--space-4); margin-bottom:var(--space-4); border-radius:var(--radius-md); border:1px solid var(--border-subtle);">
        <div class="forum-post-header" style="display:flex; align-items:center; gap:var(--space-3); margin-bottom:var(--space-2);">
          ...
          <div>
            <div class="forum-post-title" style="font-weight:600; color:var(--text-primary);">${A(s.title)}</div>
            <div class="forum-post-meta" style="font-size:var(--text-xs); color:var(--text-tertiary);">${A(s.avatar_name||"Anonymous")} · ${N(s.created_at)}</div>
          </div>
        </div>
        <div class="forum-post-body" style="font-size:var(--text-sm); color:var(--text-secondary); line-height:1.6; margin-left:var(--space-10); margin-bottom:var(--space-3);">${A(s.content)}</div>
            ...
            ${s.replies.map(e=>`
              <div class="forum-reply">
                <div class="forum-post-header" style="display:flex; align-items:center; gap:var(--space-2); margin-bottom:4px;">
                  ...
                  <div class="forum-post-meta" style="font-size:var(--text-xs); color:var(--text-tertiary);">${A(e.avatar_name||"Anonymous")} · ${N(e.created_at)}</div>
                </div>
                <div class="forum-post-body" style="font-size:var(--text-sm); line-height:1.5; color:var(--text-secondary); margin-left:var(--space-6);">${A(e.content)}</div>
    ...
    `).join("")}if(document.getElementById("forum-feed").addEventListener("click",async m=>{const d=m.target.closest(".vote-btn");if(d&&!d.disabled){const t=d.dataset.type,n=d.dataset.id,u=d.dataset.dir;d.disabled=!0;try{const g=await f.patch("/forum/vote",{type:t,id:parseInt(n,10),dir:u});if(t==="post"){const y=c.find(p=>p.post_id===parseInt(n,10));y&&(y.upvotes=g.upvotes,y.downvotes=g.downvotes)}else for(const y of c)if(y.replies){const p=y.replies.find(v=>v.reply_id===parseInt(n,10));if(p){p.upvotes=g.upvotes,p.downvotes=g.downvotes;break}}i()}catch(g){h(g.message,"error"),d.disabled=!1}return}const s=m.target.closest(".reply-toggle-btn");if(s){const t=s.dataset.postId,n=document.getElementById(`reply-form-${t}`);n&&(n.style.display=n.style.display==="none"?"block":"none");return}const e=m.target.closest(".reply-submit-btn");if(e){const t=e.dataset.postId,n=document.getElementById(`reply-input-${t}`),u=n==null?void 0:n.value.trim();if(!u){h("Reply content cannot be empty","error");return}e.disabled=!0,e.textContent="...";try{const g=await f.post(`/forum/${t}/reply`,{content:u}),y=c.find(p=>p.post_id===parseInt(t,10));y&&(y.replies||(y.replies=[]),y.replies.push(g)),h("Reply posted","success"),i()}catch(g){h(g.message,"error"),e.disabled=!1,e.textContent="Submit Reply"}return}}),!l){const m=document.getElementById("forum-form");m.addEventListener("submit",async d=>{d.preventDefault();let s=!0;a.querySelectorAll(".form-error").forEach(u=>u.classList.remove("visible"));const e=document.getElementById("f-title").value.trim(),t=document.getElementById("f-content").value.trim();if(e||(document.getElementById("err-f-title").classList.add("visible"),s=!1),t||(document.getElementById("err-f-content").classList.add("visible"),s=!1),!s)return;const n=document.getElementById("btn-post");n.disabled=!0,n.textContent="Posting…";try{c=[await f.post("/forum",{title:e,content:t}),...c],h("Posted anonymously!","success"),m.reset(),i()}catch(u){h(u.message,"error")}finally{n.disabled=!1,n.textContent="Post Anonymously"}}),m.addEventListener("reset",()=>a.querySelectorAll(".form-error").forEach(d=>d.classList.remove("visible")))}i(),requestAnimationFrame(()=>{var m;return(m=document.getElementById("forum-page"))==null?void 0:m.classList.replace("page-enter","page-active")})}function A(a){return String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function N(a){try{return new Date(a).toLocaleString("en-IN",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return a}}const O=["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],ge={breakfast:[["Poori Chole","Matter Kulcha","Kachori Bhaji","Dosa Sambar","Pav Bhaji","Macaroni","Aloo Paratha"],["Chacos","Idli Sambar","Daliya","Chana Chaat","Corn Flakes","Idli Sambar","Cut Fruits"],["Egg","Banana","Egg","—","Egg","—","—"],["Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee"],["Bread & Jam / Butter","Bread & Jam / Butter","Bread & Jam / Butter","Bread & Jam / Butter","Bread & Jam / Butter","Bread & Jam / Butter","Bread & Jam / Butter"]],lunch:[["Green Salad","Green Salad","Green Salad","Green Salad","Green Salad","Green Salad","Green Salad"],["Boondi Raita","Mix Veg Raita","Lauki Raita","Mix Veg Raita","Boondi Raita","Mix Veg Raita","Mint Raita"],["A / P / C","A / P / C","A / P / C","A / P / C","A / P / C","A / P / C","A / P / C"],["Mix Dal Tadka","Chole Masala","Kadi Pakora","Lobhiya / Black Masoor Dal","Rajma Masala","Dal Makhani","Dal Tadka"],["Matar Paneer","Aloo Nutrela","Mixed Vegetable","Paneer Do Pyaza","Handi Kofta Curry","Aloo Gobhi Masala","Chap Masala"],["Aloo Palak","Boiled Rice","Soya Chap Gravy","Boiled Rice","Boiled Rice","Boiled Rice","Veg Biryani"],["Boiled Rice","Chapathi","Jeera Rice","Cut Fruits","Chapathi","Chapathi","Chapathi"],["Chapathi","Ice Cream","Chapathi","Chapathi","—","Besan Barfi","Fruit Custard"]],hitea:[["Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee","Tea / Coffee"],["Veg Hakka Noodles","Bhaji Pakora","Veg Sandwich","Bread Pakora","Cake Slice","Potato Wedges","Aloo Sandwich"]],dinner:[["Green Salad","Green Salad","Green Salad","Green Salad","Green Salad","Green Salad","Green Salad"],["Dal Bukhara","Curd","Rajma Masala","Curd","Dal Palak","Khichdi","Curd"],["Veg Jalfrezi","Arhar Dal Fry","Palak Paneer","Mix Dal Tadka","Soya Matar Masala","Mix Vegetable","Dal Dhaba"],["Jeera Dhaniya Pulao","Crispy Veg in Sweet Chilly","Onion Pulao","Aloo Chole","Tomato Rice","Chapati","Paneer Lababdar"],["Chapathi","Aloo Jeera","Chapathi","Masala Rice","Chapathi","Hot Milk","Jeera Pulao"],["Milk","Soya Biryani","Milk","Chapathi","Milk","—","Chapathi"],["Rice Kheer","Chapathi","Fruit Custard","Milk","Boondi","—","Milk"],["—","Milk","—","—","—","—","—"]]},ye={breakfast:{label:"Breakfast",emoji:"🌅",time:"7:30 – 9:30 AM"},lunch:{label:"Lunch",emoji:"☀️",time:"12:30 – 2:30 PM"},hitea:{label:"Evening Hi-Tea",emoji:"🫖",time:"5:00 – 6:30 PM"},dinner:{label:"Dinner",emoji:"🌙",time:"7:30 – 9:30 PM"}};function fe(){const a=new Date().getDay();return a===0?6:a-1}function be(){const a=new Date().getHours();return a<10?"breakfast":a<15?"lunch":a<19?"hitea":"dinner"}async function he(a){a.innerHTML='<div class="page-loading">Loading resources…</div>';let o=[];try{o=await f.get("/resources")}catch{}xe(a,o)}function xe(a,o){var d,s;const l=fe(),c=be();a.innerHTML=`
    <div class="page-enter" id="student-resources-page">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: var(--space-4); margin-bottom: var(--space-8);">
        ${B("🍽️","Mess Menu","#section-menu")}
        ${B("💊","Pharmacy","#section-pharmacy")}
        ${B("🏥","Hospital Booking","#section-hospital")}
        ${B("👕","Laundry","#section-laundry")}
        ${B("🍕","Canteens","#section-canteens")}
        ${B("📞","Contacts","#section-contacts")}
      </div>
      ...
      <section id="section-menu" style="margin-bottom: var(--space-10);">
        ...
        <div class="cat-tabs" style="margin-bottom: var(--space-6);" id="meal-tabs">
          ${Object.entries(ye).map(([e,t])=>`
            <button class="cat-tab${e===c?" active":""}" data-meal="${e}">
              ${t.emoji} ${t.label}
              <span style="font-size:10px; opacity:0.7; display:block; line-height:1.2;">${t.time}</span>
            </button>
          `).join("")}
        </div>
        ...
        <div style="display:flex; gap:var(--space-2); flex-wrap:wrap; margin-bottom:var(--space-4);" id="day-tabs">
          ${O.map((e,t)=>`
            <button class="filter-chip${t===l?" active":""}" data-day="${t}" style="font-size:var(--text-xs);">
              ${e.slice(0,3)}${t===l?" 📍":""}
            </button>
          `).join("")}
        </div>
        ...
        <div style="margin-top:var(--space-5); padding:var(--space-4) var(--space-5); background:var(--bg-elevated); border-radius:var(--radius-lg); border:1px solid rgba(251,191,36,.25);">
          ...
          <div style="display:flex; gap:var(--space-6); flex-wrap:wrap;">
            ${["Tandoor / Poori","Matar Paneer","One Sweet"].map(e=>`
      ...
      <section id="section-hospital" style="margin-bottom: var(--space-10);">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(280px, 1fr)); gap:var(--space-4);">
          ${k("🌐 Online Booking — Amrita Hospital Faridabad",`
      ...
      <section id="section-laundry" style="margin-bottom: var(--space-10);">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(260px, 1fr)); gap:var(--space-4);">
          ${k("📅 Collection & Delivery Days",`
            <div style="display:grid; gap:var(--space-2);">
              ${[["Monday","Collection – Boys Hostel (Senior MBBS)"],["Tuesday","Collection – Girls Hostel (Senior MBBS)"],["Wednesday","Collection – Sardha Block A & B"],["Thursday","Delivery – Boys Hostel (Senior MBBS)"],["Friday","Delivery – Girls Hostel (Senior MBBS)"],["Saturday","Delivery – Sardha Block A & B"]].map(([e,t])=>`
                <div style="display:flex; gap:var(--space-3); align-items:flex-start; font-size:var(--text-sm);">
                  <span style="min-width:90px; font-weight:600; color:var(--text-primary);">${e}</span>
      ...
      <section id="section-contacts" style="margin-bottom: var(--space-10);">
        ...
        <div id="contacts-body">${$e(o)}</div>
      </section>

    </div>
  `;let i=c,r=l;function m(){const e=ge[i],t=document.getElementById("menu-panel");t&&(t.innerHTML=`
      <div style="overflow-x:auto; border-radius:var(--radius-lg); border:1px solid var(--border-subtle);">
        <table style="width:100%; border-collapse:collapse; min-width:700px;">
            ...
            <tr>
              ${O.map((n,u)=>`
                <th style="
                  ...
                  letter-spacing: .06em;
                  background: ${u===r?"linear-gradient(135deg, var(--accent-blue,#3b82f6) 0%, #6366f1 100%)":"var(--bg-elevated)"};
                  color: ${u===r?"#fff":"var(--text-secondary)"};
                  border-bottom: 2px solid ${u===r?"transparent":"var(--border-subtle)"};
                  text-align: center;
                  position: sticky;
                  top: 0;
                ">
          ...
          <tbody>
            ${e.map((n,u)=>`
              <tr style="background: ${u%2===0?"transparent":"var(--bg-elevated)"};">
                ${n.map((g,y)=>`
                  <td style="
                    padding: 10px;
                    font-size: var(--text-xs);
                    text-align: center;
                    color: ${g==="—"?"var(--text-tertiary)":y===r?"var(--text-primary)":"var(--text-secondary)"};
                    font-weight: ${y===r?"600":"400"};
                    border-bottom: 1px solid var(--border-subtle);
                    background: ${y===r?"rgba(99,102,241,.06)":"transparent"};
                    text-transform: uppercase;
                    letter-spacing: .03em;
                  ">${g}</td>
                `).join("")}
    ...
    `)}(d=document.getElementById("meal-tabs"))==null||d.querySelectorAll(".cat-tab").forEach(e=>{e.addEventListener("click",()=>{document.getElementById("meal-tabs").querySelectorAll(".cat-tab").forEach(t=>t.classList.remove("active")),e.classList.add("active"),i=e.dataset.meal,m()})}),(s=document.getElementById("day-tabs"))==null||s.querySelectorAll(".filter-chip").forEach(e=>{e.addEventListener("click",()=>{document.getElementById("day-tabs").querySelectorAll(".filter-chip").forEach(t=>t.classList.remove("active")),e.classList.add("active"),r=+e.dataset.day,m()})}),a.querySelectorAll('a[href^="#section-"]').forEach(e=>{e.addEventListener("click",t=>{var n;t.preventDefault(),(n=document.querySelector(e.getAttribute("href")))==null||n.scrollIntoView({behavior:"smooth",block:"start"})})}),m(),requestAnimationFrame(()=>{var e;return(e=document.getElementById("student-resources-page"))==null?void 0:e.classList.replace("page-enter","page-active")})}function B(a,o,l){return`
    <a href="${l}" style="
    ...
    onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='var(--border-subtle)'">
      <span style="font-size:1.75rem;">${a}</span>
      <span style="font-size:var(--text-xs); font-weight:600; text-align:center; color:var(--text-secondary);">${o}</span>
    </a>
  `}function k(a,o){return`
    <div style="
      background:var(--bg-elevated); border-radius:var(--radius-lg);
  ...
  `}function $e(a){if(!a||a.length===0)return'<p style="color:var(--text-tertiary); padding:var(--space-6); text-align:center;">No contacts added yet.</p>';const o={Plumber:"🔧",Electrician:"⚡",WiFi:"📶",Authority:"🏛️",Other:"📋"},l={};return a.forEach(c=>{l[c.category]||(l[c.category]=[]),l[c.category].push(c)}),`
    <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(280px, 1fr)); gap:var(--space-4);">
      ${Object.entries(l).map(([c,i])=>`
  ...
  `}async function Ee(a){let o="";async function l(){a.innerHTML='<div class="page-loading">Loading</div>';try{const i=o?`?hostel=${encodeURIComponent(o)}`:"",[r,m]=await Promise.all([f.get(`/dashboard/admin${i}`),f.get("/rooms")]),d=[...new Set(m.map(s=>s.hostel))].sort();c(a,r,d,o,l)}catch(i){a.innerHTML=`<div class="page-error">Failed to load: ${i.message}</div>`}}await l();function c(i,{stats:r,recentComplaints:m,wardens:d,wardenOfficePhone:s},e,t,n){const u=d.filter(p=>p.role==="Warden"),g=d.filter(p=>p.role==="Guard"),y=r.totalCapacity>0?Math.round(r.totalOccupied/r.totalCapacity*100):0;i.innerHTML=`
      <div class="page-enter" id="admin-home">
        <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end;">
          ...
          <div style="display: flex; align-items: center; gap: var(--space-3);">
            ...
            <select class="form-input" id="hostel-filter" style="width: auto; min-width: 250px; padding: var(--space-2); height: auto;">
              ...
              ${e.map(p=>`<option value="${p}" ${p===t?"selected":""}>${we(p)}</option>`).join("")}
            </select>
          </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-6);">
          ...
          <div class="form-section" style="max-width: none;">
            ...
            ${u.length===0?'<p class="empty-msg">No warden data available.</p>':u.map(p=>`
              <div class="contact-row" style="align-items: flex-start;">
                <div class="contact-avatar">${p.name[0]}</div>
                <div class="contact-info" style="flex: 1;">
                  <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2px;">
                    <div class="contact-name">${p.name}</div>
                    <a href="tel:${p.phone}" class="contact-phone" style="margin-left: auto;">${p.phone||""}</a>
                  </div>
                  <div class="contact-meta">${p.hostel}  ${p.email||""}</div>
                  <div style="display: flex; flex-wrap: wrap; gap: 12px; font-size: 11px; margin-top: 8px; padding-top: 8px; border-top: 1px solid var(--border-color); color: var(--text-secondary);">
                    <span><span style="font-weight:600; color:var(--text-tertiary);">Last:</span> ${p.previous?p.previous.name:"Unknown"}</span>
                    <span style="color:var(--accent-green);"><span style="font-weight:600;">Current:</span> Active</span>
                    <span><span style="font-weight:600; color:var(--text-tertiary);">Next:</span> ${p.next?p.next.name:"Unknown"}</span>
                  </div>
                </div>
              </div>
            `).join("")}
            <div class="form-section-title" style="margin-top: var(--space-5);">On-Duty Guards</div>
            ${g.length===0?'<p class="empty-msg">No guard data.</p>':g.map(p=>`
              <div class="contact-row">
                <div class="contact-avatar guard">${p.name[0]}</div>
                <div class="contact-info">
                  <div class="contact-name">${p.name}</div>
                  <div class="contact-meta">${p.hostel}  ${p.shift} shift</div>
                </div>
                <a href="tel:${p.phone}" class="contact-phone">${p.phone||""}</a>
              </div>
            `).join("")}
          </div>
          ...
          <div class="form-section" style="max-width: none;">
            ...
            <div class="activity-list">
              ${m.map(p=>`
                  <div class="activity-item">
                    <div class="activity-dot" style="background:${p.status==="open"?"var(--accent-amber)":p.status==="in-progress"?"var(--accent-blue)":"var(--accent-green)"}"></div>
                    <div class="activity-content">
                      <div class="activity-text">
                        <strong>${p.student_name||p.student_id}</strong>  ${p.category}
                        <span class="badge badge-${p.status}">${p.status}</span>
                      </div>
                      <div class="activity-time">${p.date}  ${p.room_id||""}</div>
                    </div>
                  </div>
                `).join("")}
            </div>
    ...
    `,i.querySelector("#hostel-filter").addEventListener("change",p=>{t=p.target.value,n()}),i.querySelectorAll('a.link-accent[href^="#"]').forEach(p=>{p.addEventListener("click",v=>{v.preventDefault(),window.location.hash=p.getAttribute("href").slice(1)})}),requestAnimationFrame(()=>{var p;return(p=document.getElementById("admin-home"))==null?void 0:p.classList.replace("page-enter","page-active")})}}function we(a){return String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const G={Plumbing:"🔧",Electricity:"⚡",WiFi:"📶",Cleanliness:"🧹",Carpentry:"🔨",Other:"📋"},U=["open","in-progress","resolved"],ke=["Plumbing","Electricity","WiFi","Cleanliness","Carpentry","Other"];async function Ce(a){a.innerHTML='<div class="page-loading">Loading…</div>';try{const o=await f.get("/complaints");Be(a,o)}catch(o){a.innerHTML=`<div class="page-error">Failed to load: ${o.message}</div>`}}function Be(a,o){let l=o,c="all",i="",r=null;a.innerHTML=`
    <div class="page-enter" id="admin-complaints-page">
      ...
      <div class="card-grid" style="margin-bottom: var(--space-6);">
        ...
        ${U.map(s=>{const e=l.filter(n=>n.status===s).length;return`<div class="card card-accent-${s==="open"?"amber":s==="in-progress"?"blue":"green"}" style="text-align:center; cursor:pointer;" data-quick="${s}">
        ...
        <div class="table-toolbar">
          ...
          <div style="display:flex; gap: var(--space-2); flex-wrap: wrap; align-items: center;">
            <select class="form-select" id="cat-filter" style="width: auto; padding: 4px 28px 4px 10px; font-size: var(--text-xs);">
              <option value="">All Categories</option>
              ${ke.map(s=>`<option value="${s}">${G[s]} ${s}</option>`).join("")}
            </select>
            <button class="filter-chip active" data-status="all">All</button>
            ${U.map(s=>`<button class="filter-chip" data-status="${s}">${s}</button>`).join("")}
          </div>
        </div>
        <div id="complaints-body"></div>
      </div>
    </div>
  `;function m(){let s=l;return i&&(s=s.filter(e=>e.category===i)),c!=="all"&&(s=s.filter(e=>e.status===c)),s}function d(){const s=m(),e=document.getElementById("complaints-body");if(s.length===0){e.innerHTML='<p style="padding:var(--space-8); text-align:center; color:var(--text-tertiary);">No complaints match the current filter.</p>';return}e.innerHTML=`
      <table>
        <thead>
          <tr>
  ...
  `;function d(){const e=i?o.filter(n=>n.hostel===i):o,t=document.getElementById("rooms-body");t.innerHTML=`
      <div class="table-container">
        <table>
          ...
          <tbody>
            ${e.map(n=>{const u=n.capacity>0?n.current_occupancy/n.capacity:0,g=u===0?"vacant":u<1?"partial":"full",y=g==="vacant"?"var(--accent-green)":g==="partial"?"var(--accent-amber)":"var(--accent-red)",p=(n.students||[]).map(v=>`<span style="font-size:var(--text-xs); color:var(--text-secondary); display:block;">${v.name} (Yr ${v.year})</span>`).join("");return`
                <tr>
                  ...
                  <td>${p||'<span style="color:var(--text-tertiary); font-size:var(--text-xs);">Vacant</span>'}</td>
                </tr>
              `}).join("")}
          </tbody>
        </table>
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <select class="form-select" id="res-cat" required>
                ...
                ${V.map(d=>`<option value="${d}">${q[d]} ${d}</option>`).join("")}
              </select>
      ...
      <div class="table-container">
        <div class="table-toolbar">
          ...
          <div style="display:flex; gap:var(--space-2); flex-wrap:wrap;">
            ...
            ${V.map(d=>`<button class="filter-chip" data-cat="${d}">${q[d]} ${d}</button>`).join("")}
          </div>
        </div>
